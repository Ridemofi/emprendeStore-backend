...
public interface EmprendedorRepository extends JpaRepository<Emprendedor, Long> {
    @Query(value = "SELECT e.id_empre, e.nombemp, e.descripempre, e.imagenempre, e.correo, e.nro_cel, e.password, e.fecha_registro, e.rol, e.saldo " +
            "FROM emprendedor e " +
            "JOIN venta v ON e.id_empre = v.id_empre " +
            "GROUP BY e.id_empre, e.nombemp, e.descripempre, e.imagenempre, e.correo, e.nro_cel, e.password, e.fecha_registro, e.rol, e.saldo " +
